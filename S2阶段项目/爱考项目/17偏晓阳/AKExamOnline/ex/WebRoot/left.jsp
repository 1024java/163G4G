...
<head>
    ...
    <script type="text/javascript">
        ...
        <%  Object nameqx=session.getAttribute("nameqx"); %>
        <%   if(nameqx=="3"){  %>
        outlookbar.additem('教师信息管理', t, 'login!jscx');
        outlookbar.additem('班级信息管理', t, '../Operations.aspx');
        outlookbar.additem('学生信息管理', t, '../AirModels.aspx');
        outlookbar.additem('题库管理', t, 'tklogin!tkcx'); 
		outlookbar.additem('试卷管理', t, 'sjlogin!sjcx');
