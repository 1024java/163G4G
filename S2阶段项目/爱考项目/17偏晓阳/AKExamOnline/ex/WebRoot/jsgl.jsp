...
<script language="javascript">
 ...
 var fun=function(id){
  ...
  var iTop = (window.screen.availHeight - 30 - iHeight) / 2; 
  var iLeft = (window.screen.availWidth - 10 - iWidth) / 2; 
  window.open('/exam/login!jssel?tea.tid='+id,'teach', 'height=' + iHeight + ',,innerHeight=' + iHeight + ',width=' + iWidth + ',innerWidth=' + iWidth + ',top=' + iTop + ',left=' + iLeft + ',status=no,toolbar=no,menubar=no,location=no,resizable=no,scrollbars=0,titlebar=no'); 
 };
</script>
<body>
...
<td>
<s:a href="javascript:fun(%{#lis.tid});">编辑</s:a>  
